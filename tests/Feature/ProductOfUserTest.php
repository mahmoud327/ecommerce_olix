...
class ProductOfUserTest extends TestCase
{

    ////test_create_product_valid_attribute_without_send_phone
    public function test_get_product_of_user_with_vaild_attribute()
    {
        ...
        $response = $this->json('post', 'api/v1/product/products_of_user/', ['Accept' => 'application/json']);
    ...
    ////test_get_product_of_user_with_invaild_attribute without token
    public function test_cant_get_product_of_user_with_invaild_attribute()
    {
