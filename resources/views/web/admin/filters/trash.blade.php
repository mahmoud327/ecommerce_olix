                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('filters.force_delete_all') }}" method="post">
                                    {{ csrf_field() }}
                            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('filters.restore_all') }}" method="post">
                                    {{ csrf_field() }}
                            </div>
                            <div class="modal-body">
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <tbody>
                            @foreach ($filters as $filter )
                                ...
                                <tr>
                                    <td><input id="cat-box" type="checkbox" name="organizations"  value="{{$filter->id}}" class="box1" ></td>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $filter->name }}</td>
                                    <td><img style="width: 80px;height:60px" src="{{asset('uploads/Filters')}}/{{$filter->image}}" alt="categories-image"></td>

                                    <td>

                                        <a  href="{{ route('filters.restore_filter', $filter->id) }}" class="btn btn-success btn-sm">restore</a>

                                        {{-- <a  href="#" data-filter_id="{{ $filter->id }}"
                                            data-toggle="modal" data-target="#force_delete_filter{{$filter->id}}"><i
                                ...
                                @include('web.admin.filters.modal_force_delete',['filter' => $filter])
                            @endforeach
                        </tbody>
                    </table>
                </div>
