...
<div class="row">
        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                        ...
                        data-toggle="modal" href="#modaldemo8"> Add Governorate</a>
                </div>
                            ...
                            @foreach ($governorates as $governorate )
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            data-toggle="modal"
                                            href="#exampleModal2{{$governorate->id}}" title="edit"><i class="las la-pen"></i></a> 
                                ...
                                @include('web.admin.governorates.edit_modal', [ 'governorate' => $governorate ])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('web.admin.governorates.add_modal')
