                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('prodouct_reports.delete_all') }}" method="post">
                                    {{ method_field('delete') }}
                                    {{ csrf_field() }}
                            </div>
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">message selected</th>
                        ...
                        <tbody>
                            @foreach ($product_reports as $product_report )
                                ...
                                <tr>
                                    ...
                                    <td><img style="width: 80px;height:60px" src="{{asset($product_report->image)}}" alt="admin-image"></td>
                                    <td>{{ optional($product_report->user)->user_name }}</td>
                                    <td>{{ $product_report->message }}</td>
                                    <td>{{ $product_report->select_message }}</td>
                                    <td>
                                     
                                         <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                         data-toggle="modal" href="#modaldemo9{{ $product_report->id }}" title="delete"><i
                                         class="las la-trash"></i></a>
                                         @include('web.admin.product_reports.delete_modal' ,['product_report'=>$product_report])
