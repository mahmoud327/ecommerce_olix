...
=                        <div  style="margin-left:70%" >
                        <form class="form-inline" action="{{ route('productOfCategory.search') }}" method="GET">
                            ...
                            <div class="form-group mx-sm-3">
                                ...
                                <input type="hidden" name="category_id" value="{{$category_id_url}}" />
...
<script>
    $(document).ready(function(){
     ...
     {
      $.ajax({
       url:"result_search/pagination/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&category_id="+category_id+"&search="+search,
