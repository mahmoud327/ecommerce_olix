                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('recurring_category.force_delete_all') }}" method="post">
                                    {{ csrf_field() }}
                            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('recurring_category.restore_all') }}" method="post">
                                    {{ csrf_field() }}
                            </div>
                            <div class="modal-body">
                        ...
                        <tbody id="tablecontents">
                            @foreach ($categories as $category )
                                ...
                                <tr data-id="{{ $category->id }}">
                                    ...
                                    <td>----</td>
                                    @endif
                                    <td>{{ optional($category->view()->first())->name }}</td>
                
                                    <td>
                                        <a  href="{{ route('recurring_category.restore_recurring_category', $category->id) }}" class="btn btn-success btn-sm">restore</a>       
                                ...
                                @include('web.admin.recurringSubCategories.modal_force_delete',['category' => $category])
