                        ...
                        @foreach ($parentCategories as $category)
                            <li>
                                    ...
                                    @if ( $category->childs()->count()  )
                                            @include('web.admin.recurringSubCategories.tree_to_categories_of_recurring_category', ['recurringSubCategory' => $recurringSubCategory, 'categories'   => $category->childs()])
                                    @endif
