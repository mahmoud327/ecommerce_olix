...
<div class="row">
        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                        ...
                        data-toggle="modal" href="#modaldemo8"> Add Property</a>
                </div>
                            ...
                            @foreach ($properties as $property )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('sub_property.index' , $property->id)}}" class="btn btn-sm btn-primary">
                                            <i class="far fa-eye"></i>
                                        </a>

                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                        data-toggle="modal"
                                        href="#exampleModal2{{$property->id}}" title="edit"><i class="las la-pen"></i></a> 

                                            
                                        <a  href="#" data-product_id="{{ $property->id }}"
                                            data-toggle="modal" data-target="#modaldemo9{{ $property->id }}"><i
                                                class="btn btn-danger  btn-sm fas fa-trash-alt"  ></i>&nbsp;&nbsp;
                                        </a>         
                            
                                        @include('web.admin.properties.delete_modal',['property' => $property])
                                        
                                    </td>
                                </tr>

                                @include('web.admin.properties.edit_modal', [ 'property' => $property ])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('web.admin.properties.add_modal')
