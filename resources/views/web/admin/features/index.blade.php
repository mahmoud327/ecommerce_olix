            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                        <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale"
                            data-toggle="modal" href="#modaldemo8">Add Feature </a>
                </div>
                <br>
                <a  href="#"
                 ...
                 <div class="modal-dialog" role="document">
                     <div class="modal-content">
                         <div class="modal-header">
                             ...
                             <form action="{{route('feature.delete_all') }}" method="post">
                                 {{ method_field('delete') }}
                                 {{ csrf_field() }}
                         </div>
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <tbody>
                            @foreach ($features as $feature )
                                ...
                                <tr>
                                    <td><input id="cat-box" type="checkbox" name="categories"  value="{{$feature->id}}" class="box1" ></td>
                                    ...
                                    <td>
                                             ...
                                             <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                 data-toggle="modal"
                                                href="#exampleModal2{{$feature->id}}" title="edit"><i class="las la-pen"></i></a> 

                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                data-toggle="modal" href="#modaldemo9{{ $feature->id }}" title="delete"><i
                                                    class="las la-trash"></i></a>

                                    </td>
                                </tr>

                                @include('web.admin.features.delete_modal', ['feature' => $feature])
                                @include('web.admin.features.edit_modal', ['feature' => $feature])
                            @endforeach
                        </tbody>
                    </table>
                </div>
