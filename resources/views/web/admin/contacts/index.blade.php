                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('contacts.delete_all') }}" method="post">
                                    {{ method_field('delete') }}
                                    {{ csrf_field() }}
                            </div>
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <tbody>
                            @foreach ($contacts as $contact )
                                ...
                                <tr>
                                    <td><input id="cat-box" type="checkbox" name="contacts"  value="{{$contact->id}}" class="box1" ></td>
                                    ...
                                    <td>
                                         ...
                                         data-toggle="modal" href="#modaldemo9{{ $contact->id }}" title="delete"><i
                                         class="las la-trash"></i></a>
                                         @include('web.admin.contacts.delete_modal' ,['contact'=>$contact])
