    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <a href="{{route('categories.index')}}" class="btn btn-sm btn-primary" style="color:white"> <i></i>&nbsp; {{trans('lang.back')}}</a>

                @else

                <a href="{{route('category.subCategories',$category_parent->parent_id)}}" class="btn btn-sm btn-primary" style="color:white"><i
                    ></i>&nbsp; {{trans('lang.back')}}</a>

                @endif

                @can('delete_product_of_category')  
                  <a  href="{{route('product.trash_products_of_catrgory', $category_id)}}" class="btn btn-danger btn-sm">{{ trans('lang.trash') }}</a> 
                @endcan

                <a  href="#"
                    data-toggle="modal" data-target="#finish_all"><i
                    class="btn btn-primary  btn-sm" id="btn_finish_all"  >finish all </i>&nbsp;&nbsp;
                </a> 
                ...
                <br>
                 ...
                 @can('create_product_of_category')
                    ...
                    <a href="{{route('product.productofcatrgorycreate',$category_id)}}" class="btn btn-sm btn-primary" style="color:white"><i
                        class="fas fa-plus"></i>&nbsp; {{ trans('lang.add_product') }}</a>
                 @endcan
                ...
                <br>
                   ...
                   @can('delete_product_of_category')  
                        ...
                        class="btn btn-danger  btn-sm" id="btn_delete_all"  >{{ trans('lang.hide') }}</i>&nbsp;&nbsp;
                   @endcan
                    </a> 
                    <br>  
                    <br>        
                    ...
                    <div class="modal fade" id="finish_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input class="text" type="hidden" id="finish_all_id" name="finish_all_id" value=''>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ trans('lang.close') }}</button>
                                    <button type="submit" class="btn btn-danger">{{ trans('lang.save') }}</button>
                    ...
                    @if($products->count())
                        ...
                        <form class="form-inline" action="{{ route('productOfCategory.search') }}" method="GET">
                            ...
                            <div class="form-group mx-sm-3">
                                ...
                                <input type="hidden" name="category_id" value="{{$products->first()->category_id}}" />
...
<script>
    $(document).ready(function(){
     ...
     {
      $.ajax({
       url:"pagination/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query+"&category_id="+category_id,
