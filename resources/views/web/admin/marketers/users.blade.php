                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">count of products</th>
                        ...
                        @if ( count( $users) )
                            ...
                            @foreach ($users as $user )
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->email }}</td>
                                    <td>{{ $user->mobile }}</td>
                                    <td>{{ $user->products()->where('marketer_code_id', $marketer_code_id)->count()}}</td>
                                    <td>   
                                 
                                     
                                    
                                        <a href="{{route( 'products_of_user_of_marketer', [ $marketer_code_id , $user->id] ) }}" class="btn btn-sm btn-primary">
