...
<div class="row">
        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                         ...
                         @can('create_organization_types')
                         <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale"
                         data-toggle="modal" href="#modaldemo8"> Add Organization Type</a>
                         @endcan
                </div>
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">{{ trans('lang.account_name') }}</th>
                            ...
                            @foreach ($organization_types as $organization_type )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('organizations')    
                                        <a href="{{route('organization.index' , $organization_type->id)}}" class="btn btn-sm btn-primary">
                                            <i class="far fa-eye"></i>
                                        </a>
                                        @endcan

                                        @can('update_organization_types')
                                            
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                            data-toggle="modal"
                                            href="#exampleModal2{{$organization_type->id}}" title="edit"><i class="las la-pen"></i></a> 

                                         @endcan
                                                                                        
                                        {{-- <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-toggle="modal" href="#modaldemo9{{ $organization_type->id }}" title="delete"><i
                                                class="las la-trash"></i></a> --}}
                                        
                                    </td>
                                </tr>

                                @include('web.admin.organization_types.delete_modal', ['organizatione_type' => $organization_type])
                                @include('web.admin.organization_types.edit_modal', ['organizatione_type' => $organization_type])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('web.admin.organization_types.add_modal')
