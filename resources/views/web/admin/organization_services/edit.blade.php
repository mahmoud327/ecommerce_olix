                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                        <div class="card  box-shadow-0">
							...
							<div class="card-body pt-0">
                                ...
                                <form action="{{route('organization_services.update',$organization_service->id)}}" method="post" enctype="multipart/form-data"> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group" id="lnWrapper">
                                                ...
                                                name="name_en" placeholder="English name"     value="{{ $organization_service->getTranslation('name', 'en')}}"/>
                                            </div>
                
                                            <div class="form-group"id="lnWrapper">
                                                <label>Arabic name: <span class="tx-danger">*</span></label>
                                                <input class="form-control" data-parsley-class-handler="#lnWrapper"
                                                 name="name_ar" placeholder="Arabic name"   value="{{ $organization_service->getTranslation('name', 'ar')}}"/>
                                            </div>

                                            
                                            @foreach($organization_services as $organization)
                                                    ...
                                                    <div>
                                                            ...
                                                            <div class="form-group" id="lnWrapper">
                                                                ...
                                                                <div class=""  id="services">
                                                                    ...
                                                                    <select name="services_id[]" class="form-control form-select" style="width:100%" required>
                        
                                                                        @foreach ($services->get() as $service)
                        
                                                                        <option  onlyslave="True"  value="{{$service->id}}" @if ( $service->id ==  $organization->service_id ) selected @endif>
                                                                            {{$service->name}}
                                                                                </option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            data-parsley-class-handler="#lnWrapper" name="price[]" type="number"  placeholder="price" required     
                                                ...
                                                <div  class="form-group"  id="other_data" class="tab-pane ">
                                                    ...
                                                    @foreach($organization_service->phones as $phone)
                                                    
                                                        <div>
                                                                <label>phone</label>
                                                                
                                                                <input class="form-control form-control"
                                                                data-parsley-class-handler="#lnWrapper" name="phones[]"  value="{{$phone}}"required type="text" placeholder="phone"      
                                                                >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" id="name" name="description" placeholder="description">{{$organization_service->description}} </textarea>
                                            </div>
                                            ...
                                            <div  class="form-group" >
                                                <div class="div_link ">
                                                    @foreach($organization_service->links as $link)
                                                    
                                                    <div>
                                                            <label>link</label>
                                                            
                                                            <input class="form-control form-control"
                                                            data-parsley-class-handler="#lnWrapper" name="links[]"  value="{{$link}}"required type="text" placeholder="link"      
                                                             >
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                    ...
                                                    <select name="city_id" id="cities" class="form-control form-select" style="width:100%" required>
                                                        ...
                                                        <option valaue="{{$organization_service->city_id}}" selected>{{optional($organization_service->city)->name}}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="google_map_link"  value="{{$organization_service->google_map_link}}"placeholder="google_map_link"> 
                                            </div>
                                        ...
                                        <div class="col-lg-8">
                                                            ...
                                                            @foreach ($parent_categories as $category)
                                                                <li> 
                                                                    ...
                                                                    @if ( $category->childs()->count() )
                                                                        @include('web.admin.organization_services.tree_category', ['categories'   => $category->childs(), 'last_level_id'   => $last_level_id, 'categories_id' => $categories_id ])
                                                                    @endif
                                                            ...
                                                            @foreach ($recurring_categories as $recurring_category)
                                                                <li> 
                                                                    ...
                                                                    @if ( $recurring_category->recurringChilds()->count() )
                                                                            ...
                                                                            @include('web.admin.organization_services.tree_recurring_category', ['recurring_categories'   => $recurring_category->recurringChilds() , 'recurring_categories_id' => $recurring_categories_id ])
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control form-control"
                                                name="image" value="{{$organization_service->image}}" type="file"> 
