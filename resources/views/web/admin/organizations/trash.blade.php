    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Dashboard</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                Organization Trash Module</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('organizations.force_delete_all') }}" method="post">
                                    {{ csrf_field() }}
                            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('organizations.restore_all') }}" method="post">
                                    {{ csrf_field() }}
                            </div>
                            <div class="modal-body">
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                        ...
                        <tbody>
                            ...
                            @foreach ($organizations as $organization)
                                ...
                                @endphp
                                <tr>
                                    <td><input id="cat-box" type="checkbox" name="organizations"  value="{{$organization->id}}" class="box1" ></td>
                                    <td>{{ $i }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a  href="{{ route('organizations.restore_organization', $organization->id) }}" class="btn btn-success btn-sm">restore</a>       
            

                                        <a  href="#" data-organization_id="{{ $organization->id }}"
                                            data-toggle="modal" data-target="#force_delete_organization{{$organization->id}}"><i
                                ...
                                @include('web.admin.organizations.modal_force_delete',['organization' => $organization])
