...
<div class="row">
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <tbody>
                            @foreach ($accounts as $account )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('sub_account')
                                            ...
                                            <a href="{{route('sub_account' , $account->id)}}" class="btn btn-sm btn-primary">
                                        ...
                                        @endcan
                                            ...
                                            @if ($account->name != 'suiiz' &&  $account->name != 'personal' &&  $account->name != 'company')
                                                
                                                <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                    data-toggle="modal"
                                                    href="#exampleModal2{{$account->id}}" title="edit"><i class="las la-pen"></i></a> 

                                                    
                                                <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                    data-toggle="modal" href="#modaldemo9{{ $account->id }}" title="delete"><i
                                ...
                                @include('web.admin.accounts.delete_modal', ['account' => $account])
                                @include('web.admin.accounts.edit_modal', ['account' => $account])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('web.admin.accounts.add_modal')
