...
<div class="row">
        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                    ...
                    <br>
                     ...
                     @can('delete_category')
                        ...
                        <a href="{{route('category.trash_catrgory' , 0)}}" class="btn btn-sm btn-danger">
                            Trash
                        </a>
                     @endcan
                     ...
                     @can('create_advertisments')
                        <a  href="{{route('advertisments.index',0)}}" ><i
            ...
            <div class="modal fade" id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
             ...
             @if($categories->count())
                  ...
                  <form class="form-inline" action="{{ route('serachParentCategory') }}" method="GET">
                ...
                <div class="table-responsive">
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center"
                        ...
                        <tbody id="tablecontents">
                            @include('web.admin.categories.pagination_data')
    ...
    @include('web.admin.categories.add_modal')
...
<script>
    $(document).ready(function(){
     ...
     {
      $.ajax({
       url:"categories/pagination/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
   ...
   <script>
    $(function(){
        ...
        $("tr").on('mousedown' ,function() {
            old_position = $(this).index();
        });

        $("tr").on('mouseup' ,function() {

            new_position = $(this).index();

            // $(this).insertAfter( $('tr:eq(0)') );
            // alert($('tr').eq(1)).index() );
            // alert( $('tr:eq('+new_position+')').index() );
            // $('tr:eq(+ old_position +)')).insertBefore( $('tr:eq('+ new_position +')') );
            // $('tr:eq('+ new_position +')')).insertBefore( $('tr:eq('+ old_position +')') );
