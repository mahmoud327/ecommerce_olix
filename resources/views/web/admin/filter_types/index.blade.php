...
<div class="row">
        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    @can('create_filter_types')

                        <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale"
                        data-toggle="modal" href="#modaldemo8"> Add Filter Type</a>
                    @endcan
                </div>
                            ...
                            @foreach ($filter_types as $filter_type )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('recurring_filter.index' , $filter_type->id)}}" class="btn btn-sm btn-primary">
                                            <i class="far fa-eye"></i>
                                        </a>

                                        @can('update_filter_types')
                                            
    
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                        data-toggle="modal"
                                        href="#exampleModal2{{$filter_type->id}}" title="edit"><i class="las la-pen"></i></a> 
                                ...
                                @include('web.admin.filter_types.edit_modal', ['filter_type' => $filter_type])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('web.admin.filter_types.add_modal')
