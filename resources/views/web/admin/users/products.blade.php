                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    ...
                                    <tr class='tr' data-s3="{{env('AWS_S3_URL')}}">
                                        ...
                                        @if( $product->status == 'pennding' ||$product->status=='finished'  )
    ...
    $(document).ready(function () {
        ...
        */
        ...
        $('#show-next-image, #show-previous-image')
            ...
            updateGallery(selector, length);
            });
        function updateGallery(selector, length) {
            let $sel = selector;
            ...
            disableButtons(length, $sel.data('image-id'));
        }
        if (setIDs == true) {
            $('[data-image-id]')
            .each(function () {
        ...
        $(setClickAttr)
            .on('click', function () {
                ...
                length = $(this).data('counter');
                
                updateGallery( $(this), length);
            });
        }
    });
    // build key actions
