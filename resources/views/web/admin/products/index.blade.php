        ...
        <div class="col-xl-12">
          ...
          <!-- ////////////////////////modela for delete///////////// -->
                    ...
                    <div class="modal fade" id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        ...
                        <div style="margin-right:15%;width:15%" >

                        <form id="search"  action="{{ route('products.serach') }}" method="post" >
                            @csrf

                                <select class="form-control" name="status" onchange="this.form.submit()">

                                    <option>اختر الفلتر</option>     
                                    <option value="pennding" >{{ trans('lang.pendding') }}</option>
                                    <option value="approve">{{ trans('lang.approve') }}</option>
                                    <option value="disapprove">{{ trans('lang.disapprove') }}</option>
                                </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a  href="#" data-product_id="{{ $product->id }}" class="btn btn-primary btn-sm"
                                                data-toggle="modal" data-target="#images{{$product->id}}"><i
                                              > {{ trans('lang.image') }}</i>
                                            </a>

                                        
                                            <a class="btn btn-outline-primary btn-sm"
                                                href=" {{ route('products.edit',$product->id)}}"><i class="fas fa-edit"></i>
                                                </a>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group mb-2">
                                                              ...
                                                              @foreach ($image->where('mediaable_id',$product->id)->get() as $images)
                                                              <div style="display:inline-block;"
                                                                  class="text-center"><img src="{{asset($images->path)}}" height="50px" width="50p">
                                                              </div>
                                                             @endforeach
