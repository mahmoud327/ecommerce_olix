    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Dashboard</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                Recurring Sub Filter Trash Module</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('recurring_sub_filters.force_delete_all') }}" method="post">
                                    {{ csrf_field() }}
                            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('recurring_sub_filters.restore_all') }}" method="post">
                                    {{ csrf_field() }}
                            </div>
                            <div class="modal-body">
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">{{ trans('lang.recurring_sub_filter_name') }}</th>
                        ...
                        <tbody>
                            @foreach ($recurring_sub_filters as $recurring_sub_filter )
                                ...
                                <tr>
                                    <td><input id="cat-box" type="checkbox" name="organizations"  value="{{$recurring_sub_filter->id}}" class="box1" ></td>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $recurring_sub_filter->name }}</td>
                                    <td><img style="width: 80px;height:60px" src="{{asset('uploads/RecuringFilter')}}/{{$recurring_sub_filter->image}}" alt="categories-image"></td>

                                    <td>
                                        
                                        <a  href="{{ route('recurring_sub_filters.restore_recurring_sub_filter', $recurring_sub_filter->id) }}" class="btn btn-success btn-sm">restore</a>

                                        {{-- <a  href="#" data-recurring_sub_filter_id="{{ $recurring_sub_filter->id }}"
                                            data-toggle="modal" data-target="#force_delete_recurring_sub_filter{{$recurring_sub_filter->id}}"><i
                                ...
                                @include('web.admin.recurring_sub_filters.modal_force_delete', ['recurring_sub_filter' => $recurring_sub_filter])
