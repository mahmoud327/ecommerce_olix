                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{route('complainments.delete_all') }}" method="post">
                                    {{ method_field('delete') }}
                                    {{ csrf_field() }}
                            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <tbody>
                            @foreach ($complainments as $complainment )

                            

                                <tr>
                                    <td><input id="cat-box" type="checkbox" name="complainments"  value="{{$complainment->id}}" class="box1" ></td>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $complainment->name }}</td>
                                    <td>{{ $complainment->message }}</td>
                                    <td>{{ $complainment->phone }}</td>
                                    <td>
                                         ...
                                         data-toggle="modal" href="#modaldemo9{{ $complainment->id }}" title="delete"><i
                                         class="las la-trash"></i></a>
                                         @include('web.admin.complainments.delete_modal' ,['complainment'=>$complainment])
