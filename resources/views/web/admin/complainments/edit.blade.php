                    ...
                    <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                        ...
                        @csrf
                            ...
                            <div class="col-md-5" id="fnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper"  name="password_confirmation" type="password" placeholder="password_confirmation">
                            </div>
                            ...
                            <div class="form-group" id="image_edit">
                                  ...
                                  <img style="width: 80px;height:60px"  src="{{asset($admin->image)}}" alt="categories-image">
