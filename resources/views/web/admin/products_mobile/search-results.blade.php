            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a href="#" data-toggle="modal" data-target="#delete_all"><i class="btn btn-danger  btn-sm"
                            id="btn_delete_all">{{ trans('lang.delete_all') }}</i>&nbsp;&nbsp;
                    </a>
                    <a href="#" data-toggle="modal" data-target="#finish_all"><i class="btn btn-primary  btn-sm"
                            id="btn_finish_all">finish all </i>&nbsp;&nbsp;
                    </a>

                    <a href="{{ route('products.trash_products_of_approve') }}" class="btn btn-danger btn-sm">trash
                        all</a>
                ...
                <div style="margin-left:70%">
                    <form class="form-inline" action="{{ route('product_mobile_approve.search') }}" method="GET">

                        <div class="form-group mx-sm-3">
                            <button type="submit" class="btn btn-primary">بحث</button>

                            <input type="text" class="form-control ml-5" name="query" id="search" placeholder=""
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                            ...
                            <tbody id="tablecontents">
                                @include('web.admin.products_mobile.pagination_data')
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "productsofmobile_aprove/pagination/fetch_data?page=" + page + "&sortby=" +
                        sort_by + "&sorttype=" +
                        sort_type + "&query=" + query + "&search=" + search,
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data.images, function(key, image) {
                            ...
                            $('.modal-body .images #sortable').append(
                                '<li class="ui-state-default image-area" data-id="' + image
                                .id + '" >' +
                                '<a class="remove-image" href="#" style="display: inline;" data-image_id="' +
                                image.id + '">&#215;</a>' +
