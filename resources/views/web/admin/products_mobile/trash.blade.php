        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    @if($by_admin=='products_disapprove')
                    <a class="btn btn-primary btn-sm" href="{{route('products.productsofmobile_disaprove')}}">{{ trans('lang.back') }}</a>
                    @elseif($by_admin=='products_approve')
                    <a class="btn btn-primary btn-sm" href="{{route('products.productsofmobile_aprove')}}">{{ trans('lang.back') }}</a>
                    @elseif($by_admin=='products_finished') 
                    <a class="btn btn-primary btn-sm" href="{{route('products.productsofmobile_finish')}}">{{ trans('lang.back') }}</a>
                    @else
                    <a class="btn btn-primary btn-sm" href="{{route('products.productsofmobile_pennding')}}">{{ trans('lang.back') }}</a>
