        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a  href="{{route('products.trash_products_of_disapprove')}}" class="btn btn-danger btn-sm">trash all</a>
                                    ...
                                    <tr  class='tr' data-s3="{{env('AWS_S3_URL')}}">
                                        ...
                                        <td>
                                            <a href="{{ route('product.approve' , $product->id) }}"
                                                class="btn btn-danger btn-sm">   reactive   </a>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{route('product.disapprove',$product->id)}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            name="rejected_reason" required placeholder="reject reason">{{$product->rejected_reason}}</textarea>
                                                         </div>
