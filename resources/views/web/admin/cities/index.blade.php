...
<div class="row">
        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                        ...
                        data-toggle="modal" href="#modaldemo8"> Add City</a>
                </div>
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0"> governorate </th>
                            ...
                            @foreach ($cities as $city )
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            data-toggle="modal"
                                            href="#exampleModal2{{$city->id}}" title="edit"><i class="las la-pen"></i></a> 
                                ...
                                @include('web.admin.cities.edit_modal', [ 'city' => $city ])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('web.admin.cities.add_modal')
