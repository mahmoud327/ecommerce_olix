...
<div class="row">
                ...
                <div class="">
                    ...
                    @can('create_view')
                      <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale"
                        data-toggle="modal" href="#modaldemo8">Add View</a>
                     @endcan
                        ...
                        <tbody>
                            @foreach ($views as $view )
                                ...
                                <tr>
                                    ...
                                    <td>{{ $view->name }}</td>
                                    <td><img style="width: 80px;height:60px" src="{{asset($view->image)}}" alt="product-image"></td>
                                    <td>
          
                                        @can('update_view')
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-toggle="modal"
                                            href="#exampleModal2{{$view->id}}" title="edit"><i class="las la-pen"></i></a> 
                                         @endcan
                                            
                                    </td>
                                    <td><input id="cat-box" type="checkbox" name="view"  value="{{$view->id}}" class="box1" ></td>
                                </tr>

                                @include('web.admin.views.delete_modal' ,['view'=>$view])
                                @include('web.admin.views.edit_modal',['view'=>$view])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('web.admin.views.add_modal')
