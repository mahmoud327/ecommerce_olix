...
<div class="row">
        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    @can('create_category_types')   
                        <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale"
                        data-toggle="modal" href="#modaldemo8"> Add Category Type</a>
                    @endcan
                </div>
                            ...
                            @foreach ($category_types as $category_type )
                                ...
                                <tr>
                                    ...
                                    <td>
                                         ...
                                         @can('recurring_category_category_types')
                                            <a href="{{route('recurring_category.index' , $category_type->id)}}" class="btn btn-sm btn-primary">
                                                <i class="far fa-eye"></i>
                                            </a>
                                        @endcan
                                        @can('update_category_types')    
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                            data-toggle="modal"
                                            href="#exampleModal2{{$category_type->id}}" title="edit"><i class="las la-pen"></i></a> 
                                        @endcan
                                ...
                                @include('web.admin.category_types.edit_modal', ['category_type' => $category_type])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('web.admin.category_types.add_modal')
