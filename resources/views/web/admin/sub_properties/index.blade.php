...
<div class="row">
        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                        ...
                        data-toggle="modal" href="#modaldemo8"> Add Sub Property</a>
                </div>
                            ...
                            @foreach ($sub_properties as $sub_property )
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            data-toggle="modal"
                                            href="#exampleModal2{{$sub_property->id}}" title="edit"><i class="las la-pen"></i></a> 

                                            <a  href="#" data-product_id="{{ $sub_property->id }}"
                                                data-toggle="modal" data-target="#modaldemo9{{ $sub_property->id }}"><i
                                                    class="btn btn-danger  btn-sm fas fa-trash-alt"  ></i>&nbsp;&nbsp;
                                            </a>         
                                
                                            @include('web.admin.sub_properties.delete_modal',['sub_property' => $sub_property])
                                    
                                        
                                    </td>
                                </tr>

                                @include('web.admin.sub_properties.edit_modal', [ 'sub_property' => $sub_property ])
                            @endforeach
                        </tbody>
                    </table>
                </div>
    ...
    @include('web.admin.sub_properties.add_modal', ['property_id' => $id])
