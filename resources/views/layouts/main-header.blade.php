...
{{--										<a href="{{url('en/index')}}" class="dropdown-item d-flex ">--}}
...
{{--							</li>--}}
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<svg xmlns="http://www.w3.org/2000/svg"  class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg><span id="con" class="pulse">{{count($notifications->where('notificationable_type','App\Models\Product')->where('is_read',0)->orderBy('id', 'DESC')->take(25)->get())}}</span></a>
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
									...
									<div class="main-notification-list Notification-scroll" id="noti">
                                      @if(count($notifications->where('is_read',0)->where('notificationable_type','App\Models\Product')->orderBy('id', 'DESC')->take(25)->get()))
                                        @foreach($notifications->where('is_read',0)->where('notificationable_type','App\Models\Product')->orderBy('id', 'DESC')->take(25)->get()  as $notification)
                                          @if($notification->getTranslation('content', 'ar') == 'product pennding')
                                                ...
                                                <a class="d-flex p-3 border-bottom" href="#">
                                                    ...
                                                    <div class="mr-3">
                                                        <h5 class="notification-label mb-1">{{$notification->getTranslation('title', 'ar')}}</h5>
                                                        <div class="notification-subtext">{{$notification->getTranslation('content', 'ar')}}</div>
                                                    </div>
